            ...
            <tbody>
              <tr>
                ...
                <th className="lg:w-[15rem]">
                  <button className="btn btn-ghost btn-xs">  <FaRupeeSign/>  {items.totalPrice}</button>
                </th>
                {/* delete */}
        ...
        <div className="my-12 flex flex-col md:flex-row justify-between items-start">
          ...
          <div className="space-x-3 md:w-1/2">
            ...
            <p className="pb-2">Total items :- {carditems.length}</p>
              <div className="flex pb-2">Total Price :- <FaRupeeSign/>
              <p>{totalPrice}</p>
              </div>

              <Link to='/payment'>
            <button className="cursor-pointer rounded-md font-semibold overflow-hidden relative z-100 border border-red-500 group px-8 py-2">
